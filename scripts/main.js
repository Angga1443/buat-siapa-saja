;(function (window) {
  ...
  let texts = ['TAP DIMANA AJA YA :)','JANGAN LUPA', 'PAKAI LANDSCAPE MODE', 'HEY', 'COBA LIHAT DEH', 'KATA INI', 'SEPERTINYA ADA YANG ANEH', 'AYO PENCET LAGI', 'AKU GA BOHONG KOK', 'PENCET LAGI', 'AKU TAHU KAMU PASTI KESAL', 'TAPI INI BENER ADA YANG ANEH', 'AKU JANJI', 'INI TERAKHIR KALI', 'PENCET LAGI', 'AYO SEMANGAT', 'KAMU PASTI BISA', 'KURANG KOCEEAAAKKK KURANG PENCET ITUUU', 'AYO DONG', 'ASLI INI TERAKHIRRRRR', 'YASUDAH DEH', 'I', 'LOVE', 'YOU ♡', 'BYE', 'MAAFIN ANGGA YA', 'KALO ANGGA BIKIN ISMA SEDIKIT KESAL']
